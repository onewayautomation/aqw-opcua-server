...
const uint16_t weatherserver::WebService::OPC_NS_INDEX = 1;
const utility::string_t weatherserver::WebService::ENDPOINT_API_OPENAQ = U("https://api.openaq.org/v1/");
const utility::string_t weatherserver::WebService::PATH_API_OPENAQ_COUNTRIES = U("countries");
const utility::string_t weatherserver::WebService::PATH_API_OPENAQ_LOCATIONS = U("locations");
const utility::string_t weatherserver::WebService::PATH_API_OPENAQ_MEASUREMENTS = U("measurements");
const utility::string_t weatherserver::WebService::PARAM_API_OPENAQ_COUNTRY = U("country");
const utility::string_t weatherserver::WebService::PARAM_API_OPENAQ_LIMIT = U("limit");

const utility::string_t weatherserver::WebService::ENDPOINT_API_DARKSKY = U("https://api.darksky.net/forecast");
const utility::string_t weatherserver::WebService::PARAM_API_DARKSKY_EXCLUDE = U("exclude");
const utility::string_t weatherserver::WebService::PARAM_API_DARKSKY_UNITS = U("units");
const std::string weatherserver::WebService::PARAM_VALUE_API_DARKSKY_MINUTELY = "minutely";
const std::string weatherserver::WebService::PARAM_VALUE_API_DARKSKY_HOURLY = "hourly";
const std::string weatherserver::WebService::PARAM_VALUE_API_DARKSKY_DAILY = "daily";

pplx::task<web::json::value> weatherserver::WebService::fetchAllCountries() {
...
pplx::task<web::json::value> weatherserver::WebService::fetchAllLocations(const std::string& countryName, const uint32_t limit) {
    web::uri_builder uriBuilder(ENDPOINT_API_OPENAQ);
...
pplx::task<web::json::value> weatherserver::WebService::fetchWeather(const double& latitude, const double& longitude) {
...
void weatherserver::WebService::setServer(UA_Server * uaServer) {
    server = uaServer;
}

void weatherserver::WebService::setSettings(const Settings& settingsObj) {
    settings = settingsObj;
}

void weatherserver::WebService::setAllCountries(const std::vector<CountryData>& allCountries) {
